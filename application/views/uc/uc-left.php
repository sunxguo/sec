<ul class="uc-left">
	...
	<li class="l1">我是卖家</li>
	<li class="<?=(isset($ucNaviSOrders     ) && $ucNaviSOrders     ) ? 'cur' : '' ?>" onclick="window.location='/uc/seller_orders'">订单管理<span id="new_orders_num" class="new_orders_num">0</span></li>
	...
	<li class="<?=(isset($ucNaviMessages     ) && $ucNaviMessages     ) ? 'cur' : '' ?>" onclick="window.location='/uc/messages'">消息管理<span id="new_orders_num" class="new_orders_num">0</span></li>	
</ul>